...
Start-BitsTransfer -Source "https://github.com/Bionic-OSE/BioniDKU-hikaru3/releases/latest/download/Hikarinfo.ps1" -Destination $env:SYSTEMDRIVE\Bionic\Hikarefresh\Hikarinfo.ps1 -ErrorAction Stop
